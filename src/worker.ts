...
function publicGuestSession(session: any) { if (!session) return session; const { archived_at, archived_by, ...safeSession } = session; return safeSession; }
