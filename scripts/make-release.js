...
const include = ['app','lib','public','scripts','server.js','package.json','next.config.js','tsconfig.json','next-env.d.ts','declarations.d.ts','README.md','START_HERE.md','.env.example'];
