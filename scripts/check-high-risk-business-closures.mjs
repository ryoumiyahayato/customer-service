...
const presetWrapper = read('src/worker-preset.ts');
...
const presetMigration = read('migrations/0014_operator_preset_messages.sql');
...
assert.match(finalWrapper, /export \{ ChatRoom \} from '\.\/worker-preset'/);
assert.match(finalWrapper, /import worker from '\.\/worker-preset'/);
...
assert.match(presetWrapper, /export \{ ChatRoom \} from '\.\/worker-entry'/);
assert.match(presetWrapper, /import entryWorker from '\.\/worker-entry'/);
assert.match(presetWrapper, /operator_preset_messages/);
assert.match(presetWrapper, /operator_preset_applications/);
assert.match(presetWrapper, /MessageService/);
assert.match(presetWrapper, /AttachmentRepository/);
assert.match(presetWrapper, /isSameOriginWrite/);
assert.match(presetWrapper, /readOperatorPolicy/);
assert.match(presetWrapper, /preset_delivery_failed/);
assert.doesNotMatch(presetWrapper, /welcomeText|operator-welcome-overlay/);
...
assert.match(presetMigration, /CREATE TABLE IF NOT EXISTS operator_preset_messages/);
assert.match(presetMigration, /CREATE TABLE IF NOT EXISTS operator_preset_applications/);
assert.match(presetMigration, /INSERT INTO operator_preset_messages/);
